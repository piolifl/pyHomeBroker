portfolio = {
    ...
    'Activos': [
            ...
            'Subtotal': [{'IMPO': '1893.61','ESPE': '09239','TESP': '1','NERE': 'X20Y4','GTOS': '0','DETA': 'A Liq','TIPO': '6',  'Hora': '14:02:33','AMPL': 'LT REP ARG AJ CER A DESC V20/05/24',
                            'DIVI': '.01', 'TICK': 'X20Y4','CANT': '1000',  'PCIO': '189.361','CAN3': '0','CAN2': '0','CAN0': '0'} ], 
